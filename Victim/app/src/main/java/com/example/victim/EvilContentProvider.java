...
public class EvilContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Log.d("MyContentProvider", "Querying: " + uri.getPath());
        ...
        if(display_name == null){
            cursor.addRow(new Object[]{null, uri.getQueryParameter("_size"), null});

        }else{
            cursor.addRow(new Object[]{display_name, uri.getQueryParameter("_size"), display_name});
        }
